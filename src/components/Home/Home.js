        ...
        <section>
            <div className='grid grid-cols-2'>
                <div className='mx-5 my-28'>
                    <h2 className='text-5xl font-bold text-zinc-700'>Your next watch</h2>
                    <h2 className='text-5xl font-bold text-blue-700'>Your best watch</h2>
            ...
            <div className='mt-8'>
                <h2 className='text-4xl font-medium m-5'>Customer Reviews ({sliceData.length})</h2>
